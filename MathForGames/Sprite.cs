...
namespace MathForGames
{
    class Sprite
    {
        ...
        /// <summary>
        /// Draws the sprite to the raylib window using the rotation, translation, and scale of the given transform
        /// </summary>
        ...
        public void Draw(Matrix3 transform)
        {
            ...
            //Sets the sprites center to the transform origins
            ...
            //Draws sprite
            Raylib.DrawTextureEx(_texture, position, (float)(rotation * 100 / Math.PI), 1, Color.WHITE);
        }
    }
}
